 ...
 */
export function AceiteTermosGate({
  termo,
  onSair,
}: {
  termo: TermoUso;
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-3xl mx-auto px-4 py-6">
          ...
          <p className="text-xs text-cinza-texto text-center mt-4">
            Role até o fim para ler o documento completo. Você pode baixar uma
            cópia em PDF a qualquer momento.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 space-y-3">
          ...
          >
            ...
            <span className="text-sm text-cinza-forte">
              Li e concordo com os Termos de Uso e Prestação de Serviços da{" "}

      ...
      return (
        <div className="flex items-center justify-center h-screen bg-creme-fundo">
          <div className="text-center space-y-4">
            <p className="text-rosa-vibrante text-xl font-semibold">Algo deu errado.</p>
            <p className="text-cinza-texto">Recarregue a página ou entre em contato com o suporte.</p>
            <button

...
export const createNotificacaoSchema = z.object({
  ...
  tipo: z.enum(['AULA_AGENDADA', 'PAGAMENTO_VENCIDO', 'PAGAMENTO_CONFIRMADO', 'MENSALIDADE_CRIADA', 'ESTORNO_ATUALIZADO', 'PRESENCA_REGISTRADA', 'REPOSICAO_OFERECIDA', 'MENSAGEM_ADMIN']),
...
export const listNotificacoesSchema = z.object({
  ...
  tipo: z.enum(['AULA_AGENDADA', 'PAGAMENTO_VENCIDO', 'PAGAMENTO_CONFIRMADO', 'MENSALIDADE_CRIADA', 'ESTORNO_ATUALIZADO', 'PRESENCA_REGISTRADA', 'REPOSICAO_OFERECIDA', 'MENSAGEM_ADMIN']).optional(),

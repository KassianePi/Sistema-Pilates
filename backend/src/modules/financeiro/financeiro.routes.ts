...
export async function financeiroRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    '/api/v1/mensalidades/:id',
    { onRequest: [authenticateToken, authorize('pagamentos', 'read')] },
    buscarMensalidadePorId,
  )
  fastify.post(
    '/api/v1/mensalidades',
    { onRequest: [authenticateToken, authorize('pagamentos', 'create')] },
    criarMensalidade,
  )
  fastify.put(
    '/api/v1/mensalidades/:id',
    { onRequest: [authenticateToken, authorize('pagamentos', 'update')] },
    atualizarMensalidade,
  )
  ...
  fastify.get(
    '/api/v1/aluno/mensalidades',
    { onRequest: [authenticateToken, requireRole('ALUNO')] },
    listarMinhasMensalidades,
  )
  fastify.post(
    '/api/v1/aluno/notificar-pagamento',
    { onRequest: [authenticateToken, requireRole('ALUNO')] },
    notificarPagamento,
  )
  fastify.post(
    '/api/v1/aluno/solicitar-avulsa',
    { onRequest: [authenticateToken, requireRole('ALUNO')] },
    solicitarAulaAvulsa,
  )
  fastify.post(
    '/api/v1/aluno/comprovantes',
    { onRequest: [authenticateToken, requireRole('ALUNO')] },
    enviarComprovante,
  )
  fastify.get(
  ...
  fastify.patch(
    '/api/v1/comprovantes/:id/analisar',
    { onRequest: [authenticateToken, authorize('pagamentos', 'update')] },
    analisarComprovante,
  )
}

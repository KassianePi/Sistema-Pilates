...
export async function presencaRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/api/v1/aluno/presencas', { onRequest: [authenticateToken, requireRole('ALUNO')] }, listarMinhasPresencas)
  ...
  fastify.post('/api/v1/presencas/batch', { onRequest: [authenticateToken, authorize('presenca', 'create')] }, registrarBatch)
